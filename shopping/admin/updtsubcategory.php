...
else
{
    ...
    {
        extract($_POST);
        $qry = "UPDATE subcategoryinfo SET subcatname ='$subcatname', catdescription = '$catdescrptn' WHERE catid ='$catid' ";
...
<div class="d-flex" id="wrapper">
    ...
    <h1 style="font-family: 'Work Sans', sans-serif;" class="display-6 text-primary text-center mt-3">Update Sub Category</h1>
        <hr class="my-2">
        ...
        <div class="form-row">
			...
			<div class="form-row">
				<div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="subcatname" name="subcatname" value="<?php echo $_GET["subcatname"]; ?>" required autocomplete="off">
                </div>
			</div>
			<div class="form-row">
                <div class="form-group col-md-12">
                    <label for="catdescrptn">Description</label>
                    <textarea class="form-control" id="catdescrptn" name="catdescrptn" cols="30" rows="10" value="<?php echo $_GET["catdescription"]; ?>" required autocomplete="off" ></textarea>
                </div>
			</div>
