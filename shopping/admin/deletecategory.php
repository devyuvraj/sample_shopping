...
else
{
    ...
    {
        extract($_POST);
        $qry = "DELETE FROM categoryinfo WHERE catid = '$catid'";
        $rs = $con-> executequery($qry);
        if($rs == "success")
        {
            $status = "Record Delete Successfully";
        }
        else
        {
            $status = "Error To Delete Record!";
        }
    }
?>
<!doctype html>
...
<div class="d-flex" id="wrapper">
    ...
    <!--Category Table Section-->
      <div class="container-fluid p-1 mt-2">
        <h1 style="font-family: 'Work Sans', sans-serif;" class="display-6 text-primary text-center mt-3">Delete Category</h1>
        <hr class="my-2">
        ...
        <form class="mb-2" id="frm" name="frm" method="post">
			...
			<div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" id="catdescrptn" name="catdescrptn" cols="30" rows="10" readonly ></textarea>
                </div>
			</div>
